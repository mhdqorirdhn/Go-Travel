        ...
        <div class="card shadow">
            <div class="card-body">
                <form action="<?php echo e(route('travel-package.store')); ?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="depatured_date">Departure Date</label>
                        <input type="date" class="form-control" name="depatured_date" placeholder="Depature Date" value="<?php echo e(old('depatured_date')); ?>">
                    </div>
                    <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gotravel\resources\views/pages/admin/travel-package/create.blade.php ENDPATH**/ ?>