...
<?php $__env->startSection('title', 'Go Travel'); ?>
...
<header class="text-center">
    ...
    <a href="<?php echo e(route('register')); ?>" class="btn-eksplore px-4 mt-5 mb-5">Eksplore</a>
</header>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 text-center">
                    <img src="<?php echo e(url('FrontEnd/Image/logos_partner.jpg')); ?>" alt="Logo Partners">
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gotravel\resources\views/pages/home.blade.php ENDPATH**/ ?>