                        ...
                        <div class="attendee">
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="{{url('FrontEnd/Image/Detailfoto-1.png')}}" alt="" height="60" />
                                        ...
                                        <td class="align-middle">
                                            <a href="#">
                                                <img src="{{url('FrontEnd/Image/ic_remove.jpg')}}" alt="" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{url('FrontEnd/Image/detailfoto-2.png')}}" alt="" height="60" />
                    ...
                    <div class="card card-details card-right">
                        ...
                        <div class="bank">
                            <div class="bank-item pb-3">
                                <img src="{{url('FrontEnd/Image/ic_bank – 1.jpg')}}" alt="" class="bank-image">
...
@push('prepend-style')
<link rel="stylesheet" href="{{url('FrontEnd/Libaries/gigjo/css/gijgo.min.css')}}" />

@endpush

@push('addon-script')
<script src="{{url('FrontEnd/Libaries/gigjo/js/gijgo.min.js')}}"></script>
